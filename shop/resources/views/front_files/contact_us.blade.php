            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="{{ url('/contact-us') }}">Contact Us</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    ...
                    <div class="contact-form-right">
                        <h2>GET IN TOUCH</h2>
                        <p>Send us your queries and valuable advices here so we can provide you the best services.</p>
                        <form action="{{ url('/get-messages') }}" method="post">
                        	@csrf
                            <div class="row">
                                <div class="col-md-12">
